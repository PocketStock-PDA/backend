...
**기간 및 수집 상태**
| 월 | 건수 | is_roundup_collected | 카드 라운드업 합계 |
|---|---|---|---|
| 2026-04 | 20건 | TRUE (5월 초 일괄 수집) | 5,200원 |
| 2026-05 | 20건 | TRUE (6월 초 일괄 수집) | 6,100원 |
| 2026-06 | 13건 | FALSE (이번 달 미수집) | 4,700원 |

**카드별 지출 패턴**
- **신한 체크카드**: 이마트·마켓컬리(장보기 분할), 편의점(GS25·CU), 교통카드 충전, 약국, 카페, 올리브영, 다이소 — 비딱한 금액 소액 다건
...
앱 가입 5일 후(2026-01-20) CMA 개설. 현재 잔액 404,990원, 연 3.5% 이자 적용.

---

### db-b-cma-transactions.csv (12건)
CMA 잔액 404,990원의 월별 누적 내역.

| 구분 | 내용 |
|---|---|
| 초기 입금 | 2026-01-20 수동 입금 340,000원 |
| 끝전 수집 (카드) | 2~5월 매월 수집. 4월(5,200원)·5월(6,100원)은 card_transactions roundup_amount 합산과 일치. 2~3월은 card_transactions 데이터 없는 기간 |
| 끝전 수집 (계좌) | 3월, 5월 신한 입출금 잔돈 수집 |
| 포인트 전환 | 4월 마이신한포인트 → CMA 15,000원 |
| 이자 | 2~5월 월 이자 (3.5% 연율 기준) |

> 6월 카드 끝전 4,700원(이마트·GS25·카페베네 등)은 card_transactions에서 `is_roundup_collected=FALSE` → 월말 배치 대기 중, CMA 미반영.

> 합계 검증: 340,000 + 8,340 + 1,250 + 5,600 + 11,200 + 2,100 + 5,200 + 15,000 + 2,800 + 6,100 + 4,300 + 3,100 = **404,990원** ✓
