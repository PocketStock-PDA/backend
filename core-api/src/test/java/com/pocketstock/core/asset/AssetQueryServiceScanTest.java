...
class AssetQueryServiceScanTest {
    ...
    void getScan_perAccountThreshold() {
        ...
        when(internalAssetService.getLinkedAccounts(USER_ID, List.of(1L, 2L))).thenReturn(List.of(
                new LinkedAccountSummary(1L, "DEMAND", BigDecimal.valueOf(12300), "KRW", null, null),  // %5000 = 2300
                new LinkedAccountSummary(2L, "DEMAND", BigDecimal.valueOf(85700), "KRW", null, null))); // %1000 = 700
